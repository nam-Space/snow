function handleStart() {
    ...
    function navBar() {
            ...
            if (body.offsetWidth <= 1023) {
                ...
                li.addEventListener("click", () => {
                    ...
                    const headerDropdown =
                        li.querySelector(".header__dropdown");
                    if (headerDropdown) {
        ...
        function subNavBar(elementDiv, elementLi) {
            ...
            number++;
            const subLis = elementDiv.querySelectorAll(
                `li[lever='li-lv${number}']`
            );
            if (subLis) {
                Array.from(subLis).forEach((subLi) => {
                    if (subLi) {
                        ...
                        subLi.addEventListener("click", () => {
                            ...
                            const headerDropdown =
                                subLi.querySelector(".header__dropdown");
                            if (headerDropdown) {
    ...
    function toggleLogin() {
        ...
        var btnSubmitRegister = document.querySelectorAll(
            ".header__modal-register"
        );
        ...
        function changeForSlide() {
            if (compare) {
                slide.style.animation =
                    "slideUp linear 6s forwards, slideAppear linear 0.3s";
                slide.style.backgroundImage =
                    "url(https://setsail.qodeinteractive.com/wp-content/uploads/2018/09/skiing-slider-img-1.jpg)";
                slideText.style.animation =
                    "slideTextUp ease-in-out 0.8s forwards";
            } else {
                slide.style.animation =
                    "slideUp2 linear 6s forwards, slideAppear2 linear 0.3s";
                slide.style.backgroundImage =
                    "url(https://images.pexels.com/photos/848618/pexels-photo-848618.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940)";
                slideText.style.animation =
                    "slideTextUp2 ease-in-out 0.8s forwards";
            }
        }
    }
